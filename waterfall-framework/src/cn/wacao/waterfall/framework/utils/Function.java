...
public class Function {
    ...
    public static <E> E lookup(int k, SparseArray<E> xs) {
        return Function.empty(xs) ? null : xs.get(k);
    }
    ...
    public static int size(SparseArray<?> xs) { return xs == null ? 0 : xs.size(); }

    public static int size(SparseIntArray xs) { return xs == null ? 0 : xs.size(); }
    ...
    public static int length(Map<?, ?> m) { return size(m); }

    public static int length(SparseArray<?> xs) { return size(xs); }

    public static int length(SparseIntArray xs) { return size(xs); }
    ...
    public static <T> void swap(List<T> xs, int i, int j) {
        T tmp = xs.get(i); xs.set(i, xs.get(j)); xs.set(j, tmp);
    }
    ...
    public static <E> List<E> del(List<E> xs, E x) {
        return delBy(new Eq<E>() {
                @Override
                public boolean eq(E x, E y) { return Function.eq(x, y); }
            }, xs, x);
    }
    ...
    public static String take(int n, String s) {
        return s.substring(0, limit(n, 0, Function.length(s)));
    }
    ...
    public static <E> E first(List<E> xs) {
        return Function.empty(xs) ? null : xs.get(0);
    }

    public static <E> E second(List<E> xs) {
        return Function.size(xs) < 2 ? null : xs.get(1);
    }
    ...
    public static <E> E last(List<E> xs) {
        return Function.empty(xs) ? null : xs.get(Function.lastIndex(xs));
    }
    ...
    public static int lastIndex(List<?> xs) {
        return Function.empty(xs) ? -1 : xs.size() - 1;
    }
    ...
    public static <T> List<T> union(List<T> xs, List<T> ys) {
        return unionBy(new Eq<T>() {
                @Override
                public boolean eq(T x, T y) { return Function.eq(x, y); }
            }, xs, ys);
    }
    ...
    public static long sum(List<Long> xs, Long _) {
        long n = 0;
        for (long x : xs)
            n += x;
        return n;
    ...
    public static int ord(Integer x) { return x == null ? 0 : x; }
