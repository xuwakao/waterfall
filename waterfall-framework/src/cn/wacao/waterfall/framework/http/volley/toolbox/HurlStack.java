...
import cn.wacao.waterfall.framework.http.volley.AuthFailureError;
import cn.wacao.waterfall.framework.http.volley.Request;
import cn.wacao.waterfall.framework.http.volley.Request.Method;
...
public class HurlStack implements HttpStack {
    ...
    public HttpResponse performRequest(Request<?> request, Map<String, String> additionalHeaders)
        ...
        VolleyLog.d("hurl stack perform request with url %s", url);
